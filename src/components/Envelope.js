      ...
      <div
        ...
        <div
          ...
          <button
            ...
            // disabled={``}
            className='rounded-lg py-4 px-6 shadow-[8px_8px_0px_0px_rgba(109,40,217)] bg-transparent bg-gradient-to-tr from-[#cc2b5e] to-[#3a1c71] active:shadow-none active:translate-x-1 active:translate-y-1 duration-75 hover:scale-110 active:scale-90 duration-200'
          >
            <div
